...
volcano_df%>%count(tactonic_settings, sort = TRUE)
...
#extract data from the one you used in the recipe
juice(volcano_prep)

#If you need to apply the recipe to a new data set ( which is not in the recipe settings) you need to use bake() function
